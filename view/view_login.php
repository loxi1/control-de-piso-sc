...
echo "<link rel='stylesheet' href='../_lib/css/css_login.css' />";
echo <<<HTML
<!DOCTYPE html>
<html lang="es">
    <head>
        ...
        <main class="container px-3">
            <div class="row justify-content-center" style="--bs-gutter-x: 0 !important;">
                <div class="col-12 col-md-10 col-lg-8 card-modern d-flex flex-column flex-md-row">
                    <!-- Formulario -->
                    <div class="col-12 col-md-6 px-4 pt-5 pb-3 border-formulario">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="text" id="codigo" class="form-control" placeholder="Ingrese su código"
                            required>
                        </div>

                        <button type="button" id="senddatos" class="btn mt-2 btn-primary w-100">
                            Acceder
                        </button>
                    </div>
                    <!-- SVG Area -->
