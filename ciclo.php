...
$operacion = [vg_operacion]; //id_costura
...
echo "
<link rel='stylesheet' href='".sc_url_library("prj","bootstrap5","css/bootstrap.min.css")."' />";
...
echo <<<HTML
    ...
    <head>
        ...
        <style>
            ...
            .header-top {
                margin-top: 0;
                /* Elimina cualquier margen superior existente */
            }
